...
2. Limpia el nombre del componente para que sea un término de búsqueda óptimo en tiendas de electrónica (ej. 'Arduino Uno R3', 'Resistencia 220 ohm 1/4W', 'ESP32 NodeMCU', 'Sensor DHT22', 'Modulo Relay 5V').
3. Ignora saludos, despedidas, preguntas de precios, charlas o comentarios irrelevantes.
4. Responde ÚNICAMENTE con un objeto JSON válido con la siguiente estructura:
{{
  "items": [
    {{
      "cantidad": 2,
      "componente": "ESP32 NodeMCU"
    }},
    {{
      "cantidad": 10,
